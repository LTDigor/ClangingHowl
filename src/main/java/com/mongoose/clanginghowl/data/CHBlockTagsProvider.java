...
public class CHBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider p_255894_) {
        ...
        this.tag(CHTags.Blocks.EX_STONE)
                ...
                .add(CHBlocks.BURNISHED_EXTRATERRESTRIAL_STONE.get())
        ...
        this.tag(CHTags.Blocks.EX_STONE_BRICKS)
                ...
                .add(CHBlocks.CHARGED_EXTRATERRESTRIAL_STONE_BRICKS.get())
                .replace(false);
        this.tag(CHTags.Blocks.EX_STEEL_BLOCKS)
                ...
                .add(CHBlocks.CORRUGATED_STEEL_BLOCK.get())
                .add(CHBlocks.EXTRATERRESTRIAL_STEEL_GRATE.get())
                .add(CHBlocks.EXTRATERRESTRIAL_STEEL_GRATE_PANEL.get())
                .add(CHBlocks.STEEL_BRIDGE.get())
                .add(CHBlocks.STEEL_BRIDGE_SLAB.get())
                .add(CHBlocks.STEEL_ROD.get())
                .add(CHBlocks.STEEL_DOOR.get())
                .add(CHBlocks.STEEL_TRAPDOOR.get())
                .replace(false);
        this.tag(CHTags.Blocks.FIREPROOF_STEEL_BLOCKS)
                .addTag(CHTags.Blocks.CARVED_FIREPROOF_STEEL)
                .add(CHBlocks.FIREPROOF_STEEL_BLOCK.get())
                .add(CHBlocks.FIREPROOF_STEEL_DOOR.get())
                .add(CHBlocks.FIREPROOF_STEEL_TRAPDOOR.get())
                .replace(false);
        this.tag(CHTags.Blocks.CARVED_STEEL)
                ...
                .replace(false);
        this.tag(CHTags.Blocks.CARVED_FIREPROOF_STEEL)
                .add(CHBlocks.CARVED_FIREPROOF_STEEL_BLOCK.get())
                .add(CHBlocks.CARVED_FIREPROOF_STEEL_STAIRS.get())
                .add(CHBlocks.CARVED_FIREPROOF_STEEL_SLAB.get())
                .replace(false);
        this.tag(CHTags.Blocks.LAMPS)
                .add(CHBlocks.STEEL_LAMP.get())
                .add(CHBlocks.BROKEN_STEEL_LAMP.get())
                .add(CHBlocks.REDSTONE_STEEL_LAMP.get())
                .replace(false);
        ...
        this.tag(CHTags.Blocks.TECHNOFLESH)
                ...
                .replace(false);
        this.tag(CHTags.Blocks.CANNOT_FROST)
                .add(CHBlocks.CRYSTAL_FORMER.get())
                .add(CHBlocks.BROKEN_CRYSTAL_FORMER.get())
                .replace(false);
        this.tag(CHTags.Blocks.BROKEN)
                .add(CHBlocks.BROKEN_STEEL_LAMP.get())
                .add(CHBlocks.BROKEN_CRYSTAL_FORMER.get())
                .replace(false);
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .addTag(CHTags.Blocks.LAMPS)
                .addTag(CHTags.Blocks.CALCITE)
                .addTag(CHTags.Blocks.ENERGY_CLUSTER)
                .addTag(CHTags.Blocks.FIREPROOF_STEEL_BLOCKS)
                .add(CHBlocks.METEORITE_STEEL_ORE.get())
                .add(CHBlocks.EXTRATERRESTRIAL_STEEL_ORE.get())
                .add(CHBlocks.EXTRATERRESTRIAL_ENERGY_CRYSTAL_BLOCK.get())
                .add(CHBlocks.BLAZE_FUEL_CYLINDER_BLOCK.get())
//                .add(CHBlocks.REDSTONE_CABLE_DISTRIBUTOR.get())
                .add(CHBlocks.CRYSTAL_FORMER.get())
                .add(CHBlocks.STATIONARY_CHARGING_STATION.get())
                .add(CHBlocks.BARRIER_OF_EXTRATERRESTRIAL_ACTIVITY.get())
                .add(CHBlocks.BROKEN_CRYSTAL_FORMER.get())
                .add(CHBlocks.FLAME_SPEWER.get())
                .add(CHBlocks.MOTION_SENSOR.get())
                .add(CHBlocks.EXTRATERRESTRIAL_ACTIVITY_RADAR.get())
                .replace(false);
