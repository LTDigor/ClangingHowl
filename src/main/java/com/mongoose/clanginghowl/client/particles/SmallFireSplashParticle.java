...
public class SmallFireSplashParticle extends GroundCircleParticle {
   private int speed;
   private final SpriteSet spriteSet;

   public SmallFireSplashParticle(ClientLevel p_233976_, double p_233977_, double p_233978_, double p_233979_, SpriteSet spriteSet) {
   ...
   public static class Provider implements ParticleProvider<SmallFireSplashParticleOption> {
      ...
      public Particle createParticle(SmallFireSplashParticleOption p_234019_, ClientLevel p_234020_, double p_234021_, double p_234022_, double p_234023_, double p_234024_, double p_234025_, double p_234026_) {
         SmallFireSplashParticle explodeParticle = new SmallFireSplashParticle(p_234020_, p_234021_, p_234022_, p_234023_, sprite);
